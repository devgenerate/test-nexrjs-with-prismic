...
/**
 * Primary content in Test1 → Primary
 *
 */
interface Test1SliceDefaultPrimary {
  /**
   * Title field in *Test1 → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: test1.primary.title
   * - **Documentation**: https://prismic.io/docs/core-concepts/rich-text-title
   *
   */
...
/**
 * Default variation for Test1 Slice
 *
 * - **API ID**: `default`
 * - **Description**: `Default`
 * - **Documentation**: https://prismic.io/docs/core-concepts/reusing-slices
 *
 */
export type Test1SliceDefault = prismicT.SharedSliceVariation<
  "default",
  Simplify<Test1SliceDefaultPrimary>,
  never
>;
/**
 * Slice variation for *Test1*
 *
 */
type Test1SliceVariation = Test1SliceDefault;
/**
 * Test1 Shared Slice
 *
 * - **API ID**: `test1`
 ...
 *
 */
export type Test1Slice = prismicT.SharedSlice<"test1", Test1SliceVariation>;
/**
